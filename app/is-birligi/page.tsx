...
<section className="bg-white py-24"><div className="container-page grid gap-5 md:grid-cols-2">{groups.map(([n,d])=><article key={n} className="rounded-[30px] border border-[#082f6312] p-9"><h2 className="text-3xl font-black text-[#082f63]">{n}</h2><p className="mt-4 leading-7 text-[#65758a]">{d}</p></article>)}</div><div className="container-page mt-12"><Link href="/iletisim" className="inline-block rounded-full bg-[#ef4e55] px-7 py-4 font-bold text-white">Görüşme talep et</Link></div></section>
</>}
